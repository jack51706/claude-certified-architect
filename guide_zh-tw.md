...
- **舊版與棄用。** 較舊的模型會繼續可用一段時間 —— Opus 4.7/4.6、Sonnet 4.5、Opus 4.5 仍可呼叫 —— 但被棄用的會在某個日期退役(例如 Opus 4.1 於 2026-08-05 退役)。追蹤退役日期,並在截止*之前*遷移,而非等 404 開始才動。
