...
- Official sources only: anthropic.com/news, platform.claude.com/docs (release notes), code.claude.com/docs/en/changelog (Claude Code), modelcontextprotocol.io (spec + extensions), and Claude Certification Program news (anthropic.com/news + the Anthropic Partner Academy / Skilljar catalog: new certifications, pricing, exam-format changes).
